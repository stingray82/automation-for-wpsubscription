...
REM ============================================
REM ============================================
SET "PLUIGN_NAME=Automation for WPSubscriptions"
SET "PLUGIN_TAGS=Automation for WPSubscriptions, Flowmattic"
SET "HEADER_SCRIPT=C:\Ignore By Avast\0. PATHED Items\Plugins\deployscripts\myplugin_headers.php"
SET "PLUGIN_DIR=C:\Users\Nathan\Git\automation-for-wpsubscription\automation-for-wpsubscription\"
IF "%PLUGIN_DIR:~-1%"=="\" SET "PLUGIN_DIR=%PLUGIN_DIR:~0,-1%"
SET "PLUGIN_FILE=%PLUGIN_DIR%\automation-for-wpsubscription.php"
SET "CHANGELOG_FILE=C:\Users\Nathan\Git\rup-changelogs\automation-for-wpsubscription.txt"
